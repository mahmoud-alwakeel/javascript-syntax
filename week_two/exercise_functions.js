...
to take a word and locate the position of a chosen letter in that given word.  
...
Call the letterFinder and pass it as its first argument as the string "test" and as its second argument, 
the string "t".
...
function letterFinder(word, match) {
    for(i = 0; i < word.length; i++) {
        if(word[i] == match) {
            ...
            console.log('-----no match ound  at', i)
        }
    }
} 
letterFinder("test", 't')